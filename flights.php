<html>
  ...
  <body>
    ...
    <div id="board" class="chartContainer splitflap">
      ...
      <!-- parameters -->
      <input type="hidden" name="data" value="arrivals" />    <!-- the type of data you want from the service -->
      <input type="hidden" name="sort" value="scheduled" />    <!-- the data group to sort by -->
